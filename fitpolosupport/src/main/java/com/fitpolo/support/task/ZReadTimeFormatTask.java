...
public class ZReadTimeFormatTask extends OrderTask {
    ...
    public ZReadTimeFormatTask(MokoOrderTaskCallback callback) {
        super(OrderType.READ_CHARACTER, OrderEnum.Z_READ_TIME_FORMAT, callback, OrderTask.RESPONSE_TYPE_WRITE_NO_RESPONSE);
